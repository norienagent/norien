...
async function TrendingPanel() {
  ...
  return (
    <Card title="Trending tokens" action={<ViewAll href="/markets?sort=change24" />}>
...
async function VolumePanel() {
  ...
  return (
    <Card title="Highest volume" action={<ViewAll href="/markets?sort=volume24" />}>
      <DegradedNotice sources={result.sources} degraded={result.degraded} />
...
async function NewLaunchesPanel() {
  ...
  return (
    <Card title="New launches" action={<ViewAll href="/markets?sort=liquidity" />}>
      <DegradedNotice sources={result.sources} degraded={result.degraded} />
...
async function LatestProjectsPanel() {
  ...
  return (
    <Card title="Latest projects" action={<ViewAll href="/projects" />}>
      <DegradedNotice sources={result.sources} degraded={result.degraded} />
      <ul>
...
async function LatestRegistryPanel() {
  ...
  return (
    <Card title="Latest registry" action={<ViewAll href="/registry" />}>
...
async function LatestToolsPanel() {
  ...
  return (
    <Card title="Latest tools" action={<ViewAll href="/tools" />}>
