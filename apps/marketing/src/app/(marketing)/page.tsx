      ...
      <div className="grid items-center gap-14 lg:grid-cols-[1.05fr_1fr]">
        <div>
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <ButtonLink href={DOCS_URL} tone="secondary">
              Read the docs
            </ButtonLink>
          </div>
  ...
  return (
    <Section id="features">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <FeatureCard title="Tool marketplace" href={`${APP_URL}/tools`}>
          Tools are plugins, never hardcoded. JSON in, JSON out, across seventeen categories.
        </FeatureCard>
        <FeatureCard title="Unified data API" href={`${APP_URL}/markets`}>
    ...
    <Section id="registry" className="bg-card">
      <div className="grid items-start gap-12 lg:grid-cols-2">
        <div>
          ...
          />
          <ButtonLink href={`${APP_URL}/registry`} tone="secondary" className="mt-6">
            Browse the registry
          </ButtonLink>
        </div>
    ...
    <Section id="runtime">
      <div className="grid items-center gap-12 lg:grid-cols-2">
        ...
        <div>
          ...
          />
          <ButtonLink href={`${APP_URL}/runtime`} tone="secondary" className="mt-6">
            View runtime status
          </ButtonLink>
        </div>
      </div>
...
function Marketplace() {
  return (
    <Section id="marketplace" className="bg-card">
      ...
      <ButtonLink href={`${APP_URL}/tools`} tone="secondary" className="mt-8">
    ...
    <Section id="docs-cta" className="bg-card">
      <div className="rounded-xl border border-line bg-accent-soft px-6 py-12 text-center sm:px-12">
        ...
        <div className="mt-7 flex flex-wrap justify-center gap-3">
          <ButtonLink href={DOCS_URL}>Read the documentation</ButtonLink>
        ...
        <p className="mt-5 text-sm text-muted">
          ...
          <Link href={APP_URL} className="text-accent underline underline-offset-2">
            the app
          </Link>
          .
        </p>
