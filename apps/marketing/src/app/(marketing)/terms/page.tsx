      ...
      <Container className="pb-20">
        <Prose>
          ...
          <p>
            ...
            <Link href={`${APP_URL}/registry`}>registry pages</Link> show every agent&apos;s manifest,
          ...
          <p>
            ...
            <Link href={`${APP_URL}/api-keys`}>API keys page</Link>. Treat the current registry as a local
            development tool.
          </p>
